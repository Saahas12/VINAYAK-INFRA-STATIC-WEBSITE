    ...
    <>
      ...
      <div className="main">
        ...
        <ul className="cards">
          <li className="cards_item">
            <div className="card">
              ...
              <div className="card_content">
                ...
                <p className="card_text">Off.S.V Road,Goregaon(W)</p>
          ...
          <li className="cards_item">
            <div className="card">
              <div className="card_image"><img src="https://is1-3.housingcdn.com/4f2250e8/b42d0c2c9c3b8d71f95d8c02fa86f7e2/v0/fs/grandness-dahisar_east-mumbai-om_saath_realties.jpeg" className='img2' alt='laxmi heights' /></div>
              <div className="card_content">
